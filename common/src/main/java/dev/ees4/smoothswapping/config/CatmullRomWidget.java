package dev.ees4.smoothswapping.config;
...
public class CatmullRomWidget extends ClickableWidget {
    ...
    public CatmullRomWidget(int x, int y, int gridWidth, int gridHeight, int borderSize, int verticalLines, int horizontalLines, List<Vec2> points) {
        ...
        this.setTooltip(new Tooltip(this.getMessage(), Text.translatable("smoothswapping.config.option.animationspeed.tooltip")));
        this.setTooltipDelay(Duration.ofSeconds(1000));
    }
